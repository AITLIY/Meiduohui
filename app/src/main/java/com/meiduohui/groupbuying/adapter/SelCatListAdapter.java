 ...
 *
 */
public class SelCatListAdapter extends RecyclerView.Adapter<SelCatListAdapter.ViewHolder> {
    //新增itemType
    public static final int ITEM_TYPE = 100;

    private Context mContext;
    private List<CategoryBean> mList;
    private SelSecCatListAdapter.OnItemClickListener onItemClickListener;

    public void setOnItemClickListener(SelSecCatListAdapter.OnItemClickListener onItemClickListener) {
        this.onItemClickListener = onItemClickListener;
    }

    public SelCatListAdapter(Context context, List<CategoryBean> list) {
        mContext = context;
        mList = list;
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private SelSecCatListAdapter mRvAdapter;
